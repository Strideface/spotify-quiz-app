  ...
  return (
    ...
    /> */}
      ...
      <div className=" flex justify-center">
        <input
          className={`rounded-3xl bg-default text-center p-2 mb-16 caret-foreground search-cancel:appearance-none search-cancel:w-3 search-cancel:h-3 search-cancel:bg-contain 
