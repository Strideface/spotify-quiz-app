...
export default function PreQuizModal({ inPlay, setInPlay, tracksReady, error }) {
  const { quizData } = useOutletContext();
  // check for an active device and show the user a message in the modal
  const {
  ...
  const medium = (
    <ul>
      ...
      <li>A 60 second preview of the track can be played</li>
    </ul>
  );
